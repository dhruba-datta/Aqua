...
export default function Contact() {
  ...
  return (
    <section className="py-24 md:py-32 bg-dark text-white overflow-hidden" id="contact" ref={sectionRef}>
      <div className="mx-auto px-6 sm:px-10 lg:px-16 max-w-[1440px]">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto opacity-0 translate-y-10 [.is-visible_&]:opacity-100 [.is-visible_&]:translate-y-0 transition-all duration-1000 delay-300">
          ...
          <a href="mailto:hello@signal.agency" className="inline-flex items-center gap-4 px-10 py-5 bg-accent text-white rounded-full font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all group shadow-2xl">
            Start a Project
